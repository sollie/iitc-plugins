...
// @category       Map Tiles
// @version        0.2.0.20180418
// @namespace      https://github.com/jonatkins/ingress-intel-total-conversion
// @updateURL      https://sparkz.no/iitc/plugins/basemap-kartverket.user.js
// @downloadURL    https://sparkz.no/iitc/plugins/basemap-kartverket.user.js
// @description    Add the color and grayscale map tiles from Kartverket.no as an optional layer.
...
function wrapper(plugin_info) {
	...
	window.plugin.mapTileKartverketMap.addLayer = function() {
		...
		var kartverketTopo2 = new L.TileLayer('http://{s}.statkart.no/gatekeeper/gk/gk.open_gmaps?layers=topo4&zoom={z}&x={x}&y={y}', kartverketOpt);
		var kartverketTopo2Grayscale = new L.TileLayer('http://{s}.statkart.no/gatekeeper/gk/gk.open_gmaps?layers=topo4graatone&zoom={z}&x={x}&y={y}', kartverketOpt);
